...
def process_image(upload):
    ...
    fig3, (ax1,ax2) = plt.subplots(nrows=2, ncols=1,sharey=True)
    ...
    # output = AdaptiveMedianFilter2(image)
    # ax3.imshow(output,cmap='gray', aspect='equal',vmin=0,vmax=255)
    # ax3.axis('off')
    # ax3.title.set_text('6. adaptive median2')
